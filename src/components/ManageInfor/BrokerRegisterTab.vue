    ...
    <div class="profile">
        <div class="avatar">
            <div class="custom-file-input">
                <label for="fileInput" class="upload-icon" v-if="!hasUploadedBrokerCertificate">
        ...
        <div class="infor">
            ...
            <el-input v-model="broker.address" placeholder="Địa chỉ"></el-input>

            <label class="label">Mô tả</label>
            <el-input type="textarea" v-model="broker.description" :autosize="{ minRows: 5}" placeholder="Mô tả về bản thân"></el-input>
            ...
            AuthApi.brokerRegister(
                ...
                () => {
                    Notification.success({
                        title: "Thành công",
                        message: "Bạn đã gửi yêu cầu đăng kí tài khoản môi giới thành công! Yêu cầu sẽ được kiểm duyệt sau!",
                    });
                },
                () => {
                    Notification.error({

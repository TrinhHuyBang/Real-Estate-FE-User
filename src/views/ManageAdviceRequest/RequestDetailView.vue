    ...
    <div class="create-post">
      <div class="container">
        <el-card class="post-infor card">
            ...
            <el-row :gutter="20">
            <el-col :span="6">
                <div class="label-infor"> Diện tích
                </div>
            </el-col>
            <el-col :span="6"><div>{{ request.data.size }}</div></el-col>
            <el-col :span="6">
                <div class="label-infor"> Tài chính
                </div>
            </el-col>
            <el-col :span="6"><div>{{ showPrice(request.data.price) }}</div></el-col>
            </el-row>
            <el-row :gutter="20">
            <el-col :span="6">
            ...
            <el-col :span="6"><div>{{ request.data.livingRoom ?  request.data.livingRoom + ' phòng' : 'N/A' }}</div></el-col>
            <el-col :span="6">
                <div class="label-infor">
                    Số phòng ngủ
                </div>
            </el-col>
            <el-col :span="6"><div>{{ request.data.bedroom ? request.data.bedroom + ' phòng' : 'N/A' }}</div></el-col>
            </el-row>
            <el-row :gutter="20">
            <el-col :span="6">
                <div class="label-infor">
            ...
            <el-col :span="6"><div>{{ request.data.floor ? request.data.floor + ' tầng' : 'N/A' }}</div></el-col>
            </el-row>
        ...
        <list-broker-applied style="width: 60%;" :brokers="brokerAccepted" :brokerAccepted="true" @deleteBroker="brokerAccepted=[]"/>
        <h3 class="page-title">Danh sách nhà môi giới đã đăng kí</h3>
        <list-broker-applied style="width: 60%;" :brokers="brokerApplieds" :disabled="brokerAccepted.length ? true : false" @acceptBroker="changeListen"/>
...
export default {
  ...
  methods: {
    ...
    getBrokerAccepted() {
        AdviceRequestApi.getBrokerAccepted(
            this.$route.params.id,
            (response) => {

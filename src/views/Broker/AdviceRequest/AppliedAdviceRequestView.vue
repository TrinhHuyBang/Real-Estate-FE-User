    ...
    <div class="container">
      <div class="nav">
        ...
        <div class="search-and-type">
          ...
          <div class="type-post">
            <el-button :class="{ active_selected: type === 'sell' }" @click="type = 'sell'" style="width: 100px; margin-right: -10px">Mua</el-button>
            <el-button :class="{ active_selected: type === 'rent' }" @click="type = 'rent'" style="width: 100px; margin-right: -10px">Thuê</el-button>
          </div>
        </div>
      </div>
      <el-tabs v-model="activeName">
        <el-tab-pane v-for="tabRequest in tabrequests" :key="tabRequest.name" :label="tabRequest.label" :name="tabRequest.name" >
          <div class="content-tab">
            <list-advice-requests class="content-tab-post" :requests="requests" @requestDeleted="listRequest(1)"/>

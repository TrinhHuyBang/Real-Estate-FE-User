    ...
    <div class="create-post">
      <div class="container">
        ...
        <el-card class="post-infor card">
          ...
          <div class="imageLayout">
            <div class="row">
              ...
              >
                <img v-if="image" :src="imagePreview(image)" />
                <el-button
        ...
        <el-card class="real-estate-infor card">
          ...
          <!-- <el-input-number class="input" style="width:100%;" id="size" v-model="size" placeholder="Nhập diện tích VD:100" :controls="false" required> </el-input-number> -->
          <el-input
            class="input input-without-controls"
            type="number"
            id="size"
            v-model="size"
            :controls="false"
...
export default {
    ...
    getPostDetail($id) {
      PostApi.detail(
        ...
        (response) => {
            ...
            this.price = this.post.price*1000
    ...
    async handelSubmit() {
      ...
      for (let i = 0; i < this.images.length; i++) {
        ...
        if(image instanceof File) {
            storageRef = ref( storage, `posts/` + Math.random().toString(36).slice(2, 8) + `${image.name}`)
  ...
  watch: {
    ...
    activeButton() {
      this.value = this.post.type_id ? this.post.type_id : null
    },
  },
};
</script>

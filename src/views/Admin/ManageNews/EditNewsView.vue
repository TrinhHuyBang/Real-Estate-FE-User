    ...
    <div class="container">
      <el-card class="post-infor card">
        ...
        <label class="label" for="name"
          >Ảnh đại diện <span class="required-field"> *</span></label
        >
        <div class="avatar">
          <div class="custom-file-input">
            ...
            <p
              ...
              class="p-error"
            >
              Ảnh đại diện cho tin tức không được để trống!
            </p>
          </div>
        </div>
        ...
        <el-input
          ...
          id="name"
          v-model="title"
          placeholder="VD: Thị Trường BĐS Hà Nội ......"
          minlength="30"
          maxlength="99"
          show-word-limit
        ></el-input>
        ...
        <label class="label" for="name"
          >Tiêu đề phụ<span class="required-field"> *</span></label
        >
        <el-input
          type="textarea"
          class="input"
          ...
          v-model="subtitle"
          :autosize="{ minRows: 4 }"
          placeholder="VD: Thị trường bất động sản Hà Nội tháng 4/2024 đã có sự bứt tốc đầy ..."
        ></el-input>
        <p v-if="submitted && !$v.subtitle.required" class="p-error">
          Tiêu đề phụ không được để trống!
        </p>

        <label class="label" style="margin-bottom: 10px" for="name"
          >Nội dung tin tức<span class="required-field"> *</span></label
        >
        <ckeditor-custom :value="content" v-model="content" type="news" />
        <p v-if="submitted && !$v.content.required" class="p-error">
        ...
        <el-input
          ...
          id="name"
          v-model="source"
          placeholder="VD: https://thanhnienviet.vn/2024/05/14/"
        ></el-input>
